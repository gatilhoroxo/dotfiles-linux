...
export CARGO_HOME="$HOME/.storage/dev/.cargo"
export RUSTUP_HOME="$HOME/.storage/dev/.rustup"
export PATH="$CARGO_HOME/bin:$PATH"

. $HOME/.storage/dev/.cargo/env

export VSCODE_EXTENSIONS="$HOME/.storage/dev/.vscode"
